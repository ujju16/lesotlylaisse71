...
Restaurant, bar et tabac au cœur de la Bourgogne - Site web moderne développé avec Next.js 16
...
Le projet suit les meilleures pratiques de Next.js 16 avec App Router :
...
│   ├── components/          # Composants réutilisables
│   ├── api/                 # API Routes
│   └── [pages]/             # Routes de pages
├── public/                  # Assets statiques
│   ├── images/              # Images organisées
│   └── *.jpg, *.png         # Assets publics
...
Tous les audits d'accessibilité critiques obtiennent un score parfait :

- ✅ ARIA Allowed Attributes - 100%
- ✅ ARIA Required Attributes - 100%
- ✅ ARIA Required Children - 100%
- ✅ ARIA Required Parent - 100%
- ✅ ARIA Roles - 100%
- ✅ ARIA Valid Attributes - 100%
- ✅ ARIA Valid Attribute Values - 100%
- ✅ Button Names - 100%
- ✅ Link Names - 100%
- ✅ Document Title - 100%
...
3. **Tests** - Tests unitaires avec Jest
4. **Build** - Build de production
5. **Security Audit** - Audit de sécurité npm

### Continuous Deployment (CD)

Le déploiement automatique sur Vercel :
...
Audits automatiques de performance et accessibilité :

- ✅ Scores Lighthouse pour chaque PR
- ✅ Rapport détaillé dans les artifacts
...
- 📦 Dépendances npm vérifiées chaque semaine
