...
export const metadata = {
  ...
  description: 'Politique de confidentialité et protection des données personnelles - LeSotLyLaisse71',
};
    ...
    >
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p>
            Cette politique peut être mise à jour occasionnellement. La date de dernière modification 
